...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'New Semester', href: '/admin/semesters/create' },
];
...
export default function CreateSemester({ academicSessions }: { academicSessions: AcademicSession[] }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="New Semester" />
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <h1 className="text-xl font-semibold">New Semester</h1>
                ...
                <form onSubmit={submit} className="max-w-lg space-y-6">
                    ...
                    <Button disabled={processing}>Create Semester</Button>
                </form>
            </div>
        </AppLayout>
    );
